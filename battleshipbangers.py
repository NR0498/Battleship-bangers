...
pygame.display.set_caption("BATTLESHIP BANGERS")

# Load images
RED_ALIEN = pygame.image.load(os.path.join("assets", "pixel_alien_red_small.png"))
GREEN_ALIEN = pygame.image.load(os.path.join("assets", "pixel_alien_green_small.png"))
PURPLE_ALIEN = pygame.image.load(os.path.join("assets", "pixel_alien_purple_small.png"))

# Player player
PLAYER_SHIP = pygame.image.load(os.path.join("assets", "pixel_ship_player.png"))
...
class Enemy(Ship):
    COLOR_MAP = {
        ...
        "purple": (PURPLE_ALIEN, PURPLE_LASER)
    }
